...
from library.views import index_all, index_books, book_detail, BookCreateView, supplier_form, SupplierCreateView, \
    ...
    AuthorUpdateView, AuthorDeleteView, FilterBooksView, BookListFilterView
...
urlpatterns = [
    ...
    path('index/books/filter', FilterBooksView.as_view(), name='book_filter'),
    ...
    path('api/', include(router.urls)),
    path('index/books/', BookListFilterView.as_view(), name='book_list'),
]
